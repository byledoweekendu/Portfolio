...
const specialOffer = [
    ...
    new Product(Math.round(Math.random()*999999), "minatures/klawiatura6.png", "Klawiatura Logitech Wireless Touch K400", 169, 
...
const monitors = [
    ...
    new Product(Math.round(Math.random()*999999), "minatures/monitor2.png", "Monitor Samsung Odyssey OLED G8", 6499, 
...
const headsets = [
    ...
    new Product(Math.round(Math.random()*999999), "minatures/headset3.png", "Słuchawki SteelSeries Arctis Nova Pro", 1548, 
...
const mouses = [
    ...
    new Product(Math.round(Math.random()*999999), "minatures/mysz4.png", "Myszka Logitech G102 LIGHTSYNC", 139, 
    ...
    new Product(Math.round(Math.random()*999999), "minatures/mysz6.png", "Myszka Microsoft Bluetooth Mouse", 59, 
    "Łączność: Bezprzewodowa", "Typ: Klasyczna", "Sensor: Optyczny", "Liczba przycisków: 3", "Rozdzielczość: 1000 dpi")
];
const keyboards = [
